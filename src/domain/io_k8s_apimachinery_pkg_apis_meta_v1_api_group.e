...
class IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_GROUP
...
feature --Access
    ...
    preferred_version: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_GROUP_VERSION_FOR_DISCOVERY
    ...
    versions: detachable LIST [IO_K8S_APIMACHINERY_PKG_APIS_META_V1_GROUP_VERSION_FOR_DISCOVERY]
...
feature -- Change Element
    ...
    set_preferred_version (a_name: like preferred_version)
        -- Set 'preferred_version' with 'a_name'.
      do
        preferred_version := a_name
      ensure
        preferred_version_set: preferred_version = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_GROUP%N")
        ...
        if attached preferred_version as l_preferred_version then
          Result.append ("%Npreferred_version:")
          Result.append (l_preferred_version.out)
          Result.append ("%N")
        end
