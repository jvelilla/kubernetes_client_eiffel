...
class IO_K8S_API_RBAC_V1_CLUSTER_ROLE
...
feature --Access
    ...
    aggregation_rule: detachable IO_K8S_API_RBAC_V1_AGGREGATION_RULE
    ...
    rules: detachable LIST [IO_K8S_API_RBAC_V1_POLICY_RULE]
      -- Rules holds all the PolicyRules for this ClusterRole

feature -- Change Element

    set_aggregation_rule (a_name: like aggregation_rule)
        -- Set 'aggregation_rule' with 'a_name'.
      do
        aggregation_rule := a_name
      ensure
        aggregation_rule_set: aggregation_rule = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_RBAC_V1_CLUSTER_ROLE%N")
        if attached aggregation_rule as l_aggregation_rule then
          Result.append ("%Naggregation_rule:")
          Result.append (l_aggregation_rule.out)
          Result.append ("%N")
        end
