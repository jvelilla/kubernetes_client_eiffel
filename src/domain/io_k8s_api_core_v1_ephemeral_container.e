...
class IO_K8S_API_CORE_V1_EPHEMERAL_CONTAINER
...
feature --Access
    ...
    target_container_name: detachable STRING_32
...
feature -- Change Element
    ...
    set_target_container_name (a_name: like target_container_name)
        -- Set 'target_container_name' with 'a_name'.
      do
        target_container_name := a_name
      ensure
        target_container_name_set: target_container_name = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_CORE_V1_EPHEMERAL_CONTAINER%N")
        ...
        if attached target_container_name as l_target_container_name then
          Result.append ("%Ntarget_container_name:")
          Result.append (l_target_container_name.out)
          Result.append ("%N")
        end
