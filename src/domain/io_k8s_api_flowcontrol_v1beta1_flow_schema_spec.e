...
class IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA_SPEC
...
feature --Access
    ...
    distinguisher_method: detachable IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_DISTINGUISHER_METHOD
      
 	matching_precedence: INTEGER_32
    	 -- `matchingPrecedence` is used to choose among the FlowSchemas that match a given request. The chosen FlowSchema is among those with the numerically lowest (which we take to be logically highest) MatchingPrecedence.  Each MatchingPrecedence value must be ranged in [1,10000]. Note that if the precedence is not specified, it will be set to 1000 as default.
    priority_level_configuration: detachable IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION_REFERENCE
      
    rules: detachable LIST [IO_K8S_API_FLOWCONTROL_V1BETA1_POLICY_RULES_WITH_SUBJECTS]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA_SPEC%N")
