...
class IO_K8S_API_CERTIFICATES_V1_CERTIFICATE_SIGNING_REQUEST_CONDITION
...
feature --Access
    ...
    last_update_time: detachable DATE_TIME
      -- Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.  Wrappers are provided for many of the factory methods that the time package offers.
...
feature -- Change Element
    ...
    set_last_update_time (a_name: like last_update_time)
        -- Set 'last_update_time' with 'a_name'.
      do
        last_update_time := a_name
      ensure
        last_update_time_set: last_update_time = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_CERTIFICATES_V1_CERTIFICATE_SIGNING_REQUEST_CONDITION%N")
        ...
        if attached last_update_time as l_last_update_time then
          Result.append ("%Nlast_update_time:")
          Result.append (l_last_update_time.out)
          Result.append ("%N")
        end
