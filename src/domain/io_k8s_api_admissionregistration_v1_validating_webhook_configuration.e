...
class IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION
...
feature --Access
    ...
    webhooks: detachable LIST [IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK]
...
feature -- Change Element
    ...
    set_webhooks (a_name: like webhooks)
        -- Set 'webhooks' with 'a_name'.
      do
        webhooks := a_name
      ensure
        webhooks_set: webhooks = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION%N")
        ...
        if attached webhooks as l_webhooks then
          across l_webhooks as ic loop
            Result.append ("%N webhooks:")
