...
class IO_K8S_API_CORE_V1_GCE_PERSISTENT_DISK_VOLUME_SOURCE
...
feature -- Change Element
    ...
    set_pd_name (a_name: like pd_name)
        -- Set 'pd_name' with 'a_name'.
      do
        pd_name := a_name
      ensure
        pd_name_set: pd_name = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_CORE_V1_GCE_PERSISTENT_DISK_VOLUME_SOURCE%N")
        ...
        if attached pd_name as l_pd_name then
          Result.append ("%Npd_name:")
          Result.append (l_pd_name.out)
          Result.append ("%N")
        end
