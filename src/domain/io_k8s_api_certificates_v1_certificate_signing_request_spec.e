...
class IO_K8S_API_CERTIFICATES_V1_CERTIFICATE_SIGNING_REQUEST_SPEC
...
feature --Access
    ...
    request: detachable ARRAY [NATURAL_8]
      -- request contains an x509 certificate signing request encoded in a \"CERTIFICATE REQUEST\" PEM block. When serialized as JSON or YAML, the data is additionally base64-encoded.
    signer_name: detachable STRING_32
    ...
    usages: detachable LIST [STRING_32]
...
feature -- Change Element
    ...
    set_signer_name (a_name: like signer_name)
        -- Set 'signer_name' with 'a_name'.
      do
        signer_name := a_name
      ensure
        signer_name_set: signer_name = a_name
      end
    ...
    set_usages (a_name: like usages)
        -- Set 'usages' with 'a_name'.
      do
        usages := a_name
      ensure
        usages_set: usages = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_CERTIFICATES_V1_CERTIFICATE_SIGNING_REQUEST_SPEC%N")
        ...
        if attached signer_name as l_signer_name then
          Result.append ("%Nsigner_name:")
          Result.append (l_signer_name.out)
          Result.append ("%N")
        end
        ...
        if attached usages as l_usages then
          across l_usages as ic loop
            Result.append ("%N usages:")
            Result.append (ic.item.out)
            Result.append ("%N")
          end
        end
