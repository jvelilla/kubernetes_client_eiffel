...
feature --Access
    ...
    conditions: detachable IO_K8S_API_DISCOVERY_V1_ENDPOINT_CONDITIONS
      
    deprecated_topology: detachable STRING_TABLE [STRING_32]
      -- deprecatedTopology contains topology information part of the v1beta1 API. This field is deprecated, and will be removed when the v1beta1 API is removed (no sooner than kubernetes v1.24).  While this field can hold values, it is not writable through the v1 API, and any attempts to write to it will be silently ignored. Topology information can be found in the zone and nodeName fields instead.
    hints: detachable IO_K8S_API_DISCOVERY_V1_ENDPOINT_HINTS
...
feature -- Change Element
    ...
    set_deprecated_topology (a_name: like deprecated_topology)
        -- Set 'deprecated_topology' with 'a_name'.
      do
        deprecated_topology := a_name
      ensure
        deprecated_topology_set: deprecated_topology = a_name
      end
    ...
    set_zone (a_name: like zone)
        -- Set 'zone' with 'a_name'.
      do
        zone := a_name
      ensure
        zone_set: zone = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_DISCOVERY_V1_ENDPOINT%N")
        ...
        if attached deprecated_topology as l_deprecated_topology then
          Result.append ("%Ndeprecated_topology:")
          across l_deprecated_topology as ic loop
            Result.append ("%N")
            Result.append ("key:")
