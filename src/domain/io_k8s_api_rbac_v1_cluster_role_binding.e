...
class IO_K8S_API_RBAC_V1_CLUSTER_ROLE_BINDING
...
feature --Access
    ...
    role_ref: detachable IO_K8S_API_RBAC_V1_ROLE_REF
      
    subjects: detachable LIST [IO_K8S_API_RBAC_V1_SUBJECT]
...
feature -- Change Element
    ...
    set_role_ref (a_name: like role_ref)
        -- Set 'role_ref' with 'a_name'.
      do
        role_ref := a_name
      ensure
        role_ref_set: role_ref = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_RBAC_V1_CLUSTER_ROLE_BINDING%N")
        ...
        if attached role_ref as l_role_ref then
          Result.append ("%Nrole_ref:")
          Result.append (l_role_ref.out)
          Result.append ("%N")
        end
