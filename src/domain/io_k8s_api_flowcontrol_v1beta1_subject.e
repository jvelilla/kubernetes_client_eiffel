...
class IO_K8S_API_FLOWCONTROL_V1BETA1_SUBJECT
...
feature --Access
    ...
    group: detachable IO_K8S_API_FLOWCONTROL_V1BETA1_GROUP_SUBJECT
      
    kind: detachable STRING_32
      -- `kind` indicates which one of the other fields is non-empty. Required
    service_account: detachable IO_K8S_API_FLOWCONTROL_V1BETA1_SERVICE_ACCOUNT_SUBJECT
      
    user: detachable IO_K8S_API_FLOWCONTROL_V1BETA1_USER_SUBJECT
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_FLOWCONTROL_V1BETA1_SUBJECT%N")
