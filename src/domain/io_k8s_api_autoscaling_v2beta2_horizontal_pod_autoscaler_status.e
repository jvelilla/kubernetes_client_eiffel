...
class IO_K8S_API_AUTOSCALING_V2BETA2_HORIZONTAL_POD_AUTOSCALER_STATUS
...
feature --Access
    ...
    conditions: detachable LIST [IO_K8S_API_AUTOSCALING_V2BETA2_HORIZONTAL_POD_AUTOSCALER_CONDITION]
      -- conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met.
    current_metrics: detachable LIST [IO_K8S_API_AUTOSCALING_V2BETA2_METRIC_STATUS]
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_AUTOSCALING_V2BETA2_HORIZONTAL_POD_AUTOSCALER_STATUS%N")
