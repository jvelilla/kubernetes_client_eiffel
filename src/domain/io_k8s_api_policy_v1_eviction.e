...
feature --Access
    ...
    delete_options: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS
...
feature -- Change Element
    ...
    set_delete_options (a_name: like delete_options)
        -- Set 'delete_options' with 'a_name'.
      do
        delete_options := a_name
      ensure
        delete_options_set: delete_options = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass IO_K8S_API_POLICY_V1_EVICTION%N")
        if attached api_version as l_api_version then
          Result.append ("%Napi_version:")
          Result.append (l_api_version.out)
          Result.append ("%N")
        end
        if attached delete_options as l_delete_options then
          Result.append ("%Ndelete_options:")
          Result.append (l_delete_options.out)
          Result.append ("%N")
        end
