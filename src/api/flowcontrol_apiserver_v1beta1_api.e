...
feature -- API Access
	...
	create_flowcontrol_apiserver_v1beta1_flow_schema (body: IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA
			-- 
			-- create a FlowSchema
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA
		require
		local
  			l_path: STRING
		...
		do
			...
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas"
			...
			elseif attached { IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA } l_response.data ({ IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA }) as l_data then
				Result := l_data
			else
	...
	create_flowcontrol_apiserver_v1beta1_priority_level_configuration (body: IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldManager", field_manager));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldValidation", field_validation));
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION } l_response.data ({ IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	delete_flowcontrol_apiserver_v1beta1_flow_schema (name: STRING_32; pretty: STRING_32; dry_run: STRING_32; grace_period_seconds: INTEGER_32; orphan_dependents: BOOLEAN; propagation_policy: STRING_32; body: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_STATUS
			-- 
			-- delete a FlowSchema
			-- 
			-- argument: name name of the FlowSchema (required)
			-- 
			-- argument: pretty If &#39;true&#39;, then the output is pretty printed. (optional, default to null)
			-- 
			-- argument: dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional, default to null)
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}"
	...
	delete_flowcontrol_apiserver_v1beta1_priority_level_configuration (name: STRING_32; pretty: STRING_32; dry_run: STRING_32; grace_period_seconds: INTEGER_32; orphan_dependents: BOOLEAN; propagation_policy: STRING_32; body: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_STATUS
			-- 
			-- delete a PriorityLevelConfiguration
			-- 
			-- argument: name name of the PriorityLevelConfiguration (required)
			-- 
			-- argument: pretty If &#39;true&#39;, then the output is pretty printed. (optional, default to null)
			-- 
			-- argument: dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional, default to null)
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "gracePeriodSeconds", grace_period_seconds));
	...
	flowcontrol_apiserver_v1beta1_ap_iresources : detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_RESOURCE_LIST
		...
		do
			...
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/"
	...
	list_flowcontrol_apiserver_v1beta1_flow_schema (pretty: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA_LIST
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA_LIST
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA_LIST } l_response.data ({ IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA_LIST }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	list_flowcontrol_apiserver_v1beta1_priority_level_configuration (pretty: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION_LIST
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION_LIST
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION_LIST } l_response.data ({ IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION_LIST }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	patch_flowcontrol_apiserver_v1beta1_flow_schema (name: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA
			-- 
	...
	patch_flowcontrol_apiserver_v1beta1_flow_schema_status (name: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA
			-- 
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/flowschemas/{name}/status"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldManager", field_manager));
	...
	patch_flowcontrol_apiserver_v1beta1_priority_level_configuration (name: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION
			-- 
	...
	patch_flowcontrol_apiserver_v1beta1_priority_level_configuration_status (name: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION
			-- 
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}/status"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldManager", field_manager));
	...
	read_flowcontrol_apiserver_v1beta1_flow_schema (name: STRING_32; pretty: STRING_32): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA
			-- 
	...
	read_flowcontrol_apiserver_v1beta1_flow_schema_status (name: STRING_32; pretty: STRING_32): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA
			-- 
	...
	read_flowcontrol_apiserver_v1beta1_priority_level_configuration (name: STRING_32; pretty: STRING_32): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION
			-- 
	...
	read_flowcontrol_apiserver_v1beta1_priority_level_configuration_status (name: STRING_32; pretty: STRING_32): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_PRIORITY_LEVEL_CONFIGURATION
			-- 
	...
	replace_flowcontrol_apiserver_v1beta1_flow_schema (name: STRING_32; body: IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA
			-- 
	...
	replace_flowcontrol_apiserver_v1beta1_flow_schema_status (name: STRING_32; body: IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_FLOWCONTROL_V1BETA1_FLOW_SCHEMA
			-- 
	...
	watch_flowcontrol_apiserver_v1beta1_flow_schema (name: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
		...
		do
			...
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/watch/flowschemas/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
	...
	watch_flowcontrol_apiserver_v1beta1_flow_schema_list (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/watch/flowschemas"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "labelSelector", label_selector));
	...
	watch_flowcontrol_apiserver_v1beta1_priority_level_configuration (name: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
		...
		do
			...
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/watch/prioritylevelconfigurations/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
	...
	watch_flowcontrol_apiserver_v1beta1_priority_level_configuration_list (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/flowcontrol.apiserver.k8s.io/v1beta1/watch/prioritylevelconfigurations"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "labelSelector", label_selector));
