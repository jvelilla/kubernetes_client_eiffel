...
feature -- API Access
	...
	create_policy_v1_namespaced_pod_disruption_budget (namespace: STRING_32; body: IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET
		require
		local
  			l_path: STRING
		...
		do
			...
			l_path := "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets"
			...
			elseif attached { IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET } l_response.data ({ IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET }) as l_data then
				Result := l_data
			else
	...
	delete_policy_v1_namespaced_pod_disruption_budget (name: STRING_32; namespace: STRING_32; pretty: STRING_32; dry_run: STRING_32; grace_period_seconds: INTEGER_32; orphan_dependents: BOOLEAN; propagation_policy: STRING_32; body: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_STATUS
			-- 
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}"
	...
	list_policy_v1_namespaced_pod_disruption_budget (namespace: STRING_32; pretty: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET_LIST
			...
			-- 
			-- 
			-- Result IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET_LIST
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET_LIST } l_response.data ({ IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET_LIST }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	list_policy_v1_pod_disruption_budget_for_all_namespaces (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET_LIST
		...
		do
			...
			l_path := "/apis/policy/v1/poddisruptionbudgets"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "labelSelector", label_selector));
	...
	patch_policy_v1_namespaced_pod_disruption_budget (name: STRING_32; namespace: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET
			-- 
	...
	patch_policy_v1_namespaced_pod_disruption_budget_status (name: STRING_32; namespace: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET
			-- 
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
	...
	read_policy_v1_namespaced_pod_disruption_budget (name: STRING_32; namespace: STRING_32; pretty: STRING_32): detachable IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET
			-- 
	...
	read_policy_v1_namespaced_pod_disruption_budget_status (name: STRING_32; namespace: STRING_32; pretty: STRING_32): detachable IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET
			-- 
	...
	replace_policy_v1_namespaced_pod_disruption_budget (name: STRING_32; namespace: STRING_32; body: IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET
			-- 
	...
	replace_policy_v1_namespaced_pod_disruption_budget_status (name: STRING_32; namespace: STRING_32; body: IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET
			-- 
	...
	watch_policy_v1_namespaced_pod_disruption_budget (name: STRING_32; namespace: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
		...
		do
			...
			l_path := "/apis/policy/v1/watch/namespaces/{namespace}/poddisruptionbudgets/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
	...
	watch_policy_v1_namespaced_pod_disruption_budget_list (namespace: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/policy/v1/watch/namespaces/{namespace}/poddisruptionbudgets"
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
	...
	watch_policy_v1_pod_disruption_budget_list_for_all_namespaces (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/policy/v1/watch/poddisruptionbudgets"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "labelSelector", label_selector));
