...
feature -- API Access
	...
	create_batch_v1_namespaced_cron_job (namespace: STRING_32; body: IO_K8S_API_BATCH_V1_CRON_JOB; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_BATCH_V1_CRON_JOB
			-- 
			-- create a CronJob
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_BATCH_V1_CRON_JOB
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			l_path := "/apis/batch/v1/namespaces/{namespace}/cronjobs"
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_BATCH_V1_CRON_JOB } l_response.data ({ IO_K8S_API_BATCH_V1_CRON_JOB }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	create_batch_v1_namespaced_job (namespace: STRING_32; body: IO_K8S_API_BATCH_V1_JOB; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_BATCH_V1_JOB
			-- 
			-- create a Job
			-- 
			-- argument: namespace object name and auth scope, such as for teams and projects (required)
			...
			-- 
			-- 
			-- Result IO_K8S_API_BATCH_V1_JOB
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/batch/v1/namespaces/{namespace}/jobs"
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldManager", field_manager));
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_BATCH_V1_JOB } l_response.data ({ IO_K8S_API_BATCH_V1_JOB }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	delete_batch_v1_namespaced_cron_job (name: STRING_32; namespace: STRING_32; pretty: STRING_32; dry_run: STRING_32; grace_period_seconds: INTEGER_32; orphan_dependents: BOOLEAN; propagation_policy: STRING_32; body: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_STATUS
			-- 
			-- delete a CronJob
			-- 
			-- argument: name name of the CronJob (required)
			-- 
			-- argument: namespace object name and auth scope, such as for teams and projects (required)
			-- 
			-- argument: pretty If &#39;true&#39;, then the output is pretty printed. (optional, default to null)
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}"
	...
	delete_batch_v1_namespaced_job (name: STRING_32; namespace: STRING_32; pretty: STRING_32; dry_run: STRING_32; grace_period_seconds: INTEGER_32; orphan_dependents: BOOLEAN; propagation_policy: STRING_32; body: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_STATUS
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/batch/v1/namespaces/{namespace}/jobs/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
	...
	list_batch_v1_cron_job_for_all_namespaces (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_BATCH_V1_CRON_JOB_LIST
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_BATCH_V1_CRON_JOB_LIST
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_BATCH_V1_CRON_JOB_LIST } l_response.data ({ IO_K8S_API_BATCH_V1_CRON_JOB_LIST }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	list_batch_v1_job_for_all_namespaces (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_BATCH_V1_JOB_LIST
			...
			-- 
			-- 
			-- Result IO_K8S_API_BATCH_V1_JOB_LIST
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_BATCH_V1_JOB_LIST } l_response.data ({ IO_K8S_API_BATCH_V1_JOB_LIST }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	list_batch_v1_namespaced_cron_job (namespace: STRING_32; pretty: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_BATCH_V1_CRON_JOB_LIST
			-- 
			-- list or watch objects of kind CronJob
			-- 
			-- argument: namespace object name and auth scope, such as for teams and projects (required)
	...
	list_batch_v1_namespaced_job (namespace: STRING_32; pretty: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_BATCH_V1_JOB_LIST
			-- 
			-- list or watch objects of kind Job
			-- 
			-- argument: namespace object name and auth scope, such as for teams and projects (required)
	...
	patch_batch_v1_namespaced_cron_job (name: STRING_32; namespace: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_BATCH_V1_CRON_JOB
			-- 
	...
	patch_batch_v1_namespaced_cron_job_status (name: STRING_32; namespace: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_BATCH_V1_CRON_JOB
			-- 
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
	...
	patch_batch_v1_namespaced_job (name: STRING_32; namespace: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_BATCH_V1_JOB
			-- 
	...
	patch_batch_v1_namespaced_job_status (name: STRING_32; namespace: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_BATCH_V1_JOB
			-- 
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/batch/v1/namespaces/{namespace}/jobs/{name}/status"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
	...
	read_batch_v1_namespaced_cron_job (name: STRING_32; namespace: STRING_32; pretty: STRING_32): detachable IO_K8S_API_BATCH_V1_CRON_JOB
			-- 
	...
	read_batch_v1_namespaced_cron_job_status (name: STRING_32; namespace: STRING_32; pretty: STRING_32): detachable IO_K8S_API_BATCH_V1_CRON_JOB
			-- 
	...
	read_batch_v1_namespaced_job (name: STRING_32; namespace: STRING_32; pretty: STRING_32): detachable IO_K8S_API_BATCH_V1_JOB
			-- 
	...
	read_batch_v1_namespaced_job_status (name: STRING_32; namespace: STRING_32; pretty: STRING_32): detachable IO_K8S_API_BATCH_V1_JOB
			-- 
	...
	replace_batch_v1_namespaced_cron_job (name: STRING_32; namespace: STRING_32; body: IO_K8S_API_BATCH_V1_CRON_JOB; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_BATCH_V1_CRON_JOB
			-- 
	...
	replace_batch_v1_namespaced_cron_job_status (name: STRING_32; namespace: STRING_32; body: IO_K8S_API_BATCH_V1_CRON_JOB; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_BATCH_V1_CRON_JOB
			-- 
	...
	replace_batch_v1_namespaced_job (name: STRING_32; namespace: STRING_32; body: IO_K8S_API_BATCH_V1_JOB; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_BATCH_V1_JOB
			-- 
	...
	replace_batch_v1_namespaced_job_status (name: STRING_32; namespace: STRING_32; body: IO_K8S_API_BATCH_V1_JOB; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_BATCH_V1_JOB
			-- 
	...
	watch_batch_v1_cron_job_list_for_all_namespaces (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
		...
		do
			...
			l_path := "/apis/batch/v1/watch/cronjobs"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "labelSelector", label_selector));
	...
	watch_batch_v1_job_list_for_all_namespaces (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/batch/v1/watch/jobs"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "labelSelector", label_selector));
	...
	watch_batch_v1_namespaced_cron_job (name: STRING_32; namespace: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
		...
		do
			...
			l_path := "/apis/batch/v1/watch/namespaces/{namespace}/cronjobs/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
	...
	watch_batch_v1_namespaced_cron_job_list (namespace: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
			-- watch individual changes to a list of CronJob. deprecated: use the &#39;watch&#39; parameter with a list operation instead.
			-- 
			-- argument: namespace object name and auth scope, such as for teams and projects (required)
		...
		do
			...
			l_path := "/apis/batch/v1/watch/namespaces/{namespace}/cronjobs"
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
	...
	watch_batch_v1_namespaced_job (name: STRING_32; namespace: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
		...
		do
			...
			l_path := "/apis/batch/v1/watch/namespaces/{namespace}/jobs/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
	...
	watch_batch_v1_namespaced_job_list (namespace: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
			-- watch individual changes to a list of Job. deprecated: use the &#39;watch&#39; parameter with a list operation instead.
			-- 
			-- argument: namespace object name and auth scope, such as for teams and projects (required)
		...
		do
			...
			l_path := "/apis/batch/v1/watch/namespaces/{namespace}/jobs"
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
