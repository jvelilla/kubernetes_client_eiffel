...
feature -- API Access
	...
	coordination_v1_ap_iresources : detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_RESOURCE_LIST
		...
		do
			...
			l_path := "/apis/coordination.k8s.io/v1/"
	...
	create_coordination_v1_namespaced_lease (namespace: STRING_32; body: IO_K8S_API_COORDINATION_V1_LEASE; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_COORDINATION_V1_LEASE
			-- 
			-- create a Lease
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_COORDINATION_V1_LEASE
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			l_path := "/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases"
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_COORDINATION_V1_LEASE } l_response.data ({ IO_K8S_API_COORDINATION_V1_LEASE }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	delete_coordination_v1_namespaced_lease (name: STRING_32; namespace: STRING_32; pretty: STRING_32; dry_run: STRING_32; grace_period_seconds: INTEGER_32; orphan_dependents: BOOLEAN; propagation_policy: STRING_32; body: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_STATUS
			-- 
			-- delete a Lease
			-- 
			-- argument: name name of the Lease (required)
			-- 
			-- argument: namespace object name and auth scope, such as for teams and projects (required)
			-- 
			-- argument: pretty If &#39;true&#39;, then the output is pretty printed. (optional, default to null)
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}"
	...
	list_coordination_v1_lease_for_all_namespaces (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_COORDINATION_V1_LEASE_LIST
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_COORDINATION_V1_LEASE_LIST
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			l_path := "/apis/coordination.k8s.io/v1/leases"
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_COORDINATION_V1_LEASE_LIST } l_response.data ({ IO_K8S_API_COORDINATION_V1_LEASE_LIST }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	list_coordination_v1_namespaced_lease (namespace: STRING_32; pretty: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_COORDINATION_V1_LEASE_LIST
			-- 
			-- list or watch objects of kind Lease
			-- 
			-- argument: namespace object name and auth scope, such as for teams and projects (required)
	...
	patch_coordination_v1_namespaced_lease (name: STRING_32; namespace: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_COORDINATION_V1_LEASE
			-- 
	...
	read_coordination_v1_namespaced_lease (name: STRING_32; namespace: STRING_32; pretty: STRING_32): detachable IO_K8S_API_COORDINATION_V1_LEASE
			-- 
	...
	replace_coordination_v1_namespaced_lease (name: STRING_32; namespace: STRING_32; body: IO_K8S_API_COORDINATION_V1_LEASE; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_COORDINATION_V1_LEASE
			-- 
	...
	watch_coordination_v1_lease_list_for_all_namespaces (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/coordination.k8s.io/v1/watch/leases"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "labelSelector", label_selector));
	...
	watch_coordination_v1_namespaced_lease (name: STRING_32; namespace: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
	...
	watch_coordination_v1_namespaced_lease_list (namespace: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases"
			l_path.replace_substring_all ("{"+"namespace"+"}", api_client.url_encode (namespace.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
