...
feature -- API Access
	...
	admissionregistration_v1_ap_iresources : detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_RESOURCE_LIST
		...
		do
			...
			l_path := "/apis/admissionregistration.k8s.io/v1/"
	...
	create_admissionregistration_v1_mutating_webhook_configuration (body: IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			l_path := "/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations"
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION } l_response.data ({ IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	create_admissionregistration_v1_validating_webhook_configuration (body: IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldManager", field_manager));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldValidation", field_validation));
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION } l_response.data ({ IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	delete_admissionregistration_v1_collection_validating_webhook_configuration (pretty: STRING_32; continue: STRING_32; dry_run: STRING_32; field_selector: STRING_32; grace_period_seconds: INTEGER_32; label_selector: STRING_32; limit: INTEGER_32; orphan_dependents: BOOLEAN; propagation_policy: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; body: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_STATUS
			-- 
	...
	delete_admissionregistration_v1_mutating_webhook_configuration (name: STRING_32; pretty: STRING_32; dry_run: STRING_32; grace_period_seconds: INTEGER_32; orphan_dependents: BOOLEAN; propagation_policy: STRING_32; body: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_STATUS
			-- 
			-- delete a MutatingWebhookConfiguration
			-- 
			-- argument: name name of the MutatingWebhookConfiguration (required)
			-- 
			-- argument: pretty If &#39;true&#39;, then the output is pretty printed. (optional, default to null)
			-- 
			-- argument: dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional, default to null)
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}"
	...
	delete_admissionregistration_v1_validating_webhook_configuration (name: STRING_32; pretty: STRING_32; dry_run: STRING_32; grace_period_seconds: INTEGER_32; orphan_dependents: BOOLEAN; propagation_policy: STRING_32; body: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_STATUS
			-- 
			-- delete a ValidatingWebhookConfiguration
			-- 
			-- argument: name name of the ValidatingWebhookConfiguration (required)
			-- 
			-- argument: pretty If &#39;true&#39;, then the output is pretty printed. (optional, default to null)
			-- 
			-- argument: dry_run When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed (optional, default to null)
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "pretty", pretty));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "dryRun", dry_run));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "gracePeriodSeconds", grace_period_seconds));
	...
	list_admissionregistration_v1_mutating_webhook_configuration (pretty: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION_LIST
			...
			-- 
			-- 
			-- Result IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION_LIST
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION_LIST } l_response.data ({ IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION_LIST }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	list_admissionregistration_v1_validating_webhook_configuration (pretty: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION_LIST
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION_LIST
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION_LIST } l_response.data ({ IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION_LIST }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	patch_admissionregistration_v1_mutating_webhook_configuration (name: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION
			-- 
	...
	patch_admissionregistration_v1_validating_webhook_configuration (name: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION
			-- 
	...
	read_admissionregistration_v1_mutating_webhook_configuration (name: STRING_32; pretty: STRING_32): detachable IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION
			-- 
	...
	read_admissionregistration_v1_validating_webhook_configuration (name: STRING_32; pretty: STRING_32): detachable IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION
			-- 
	...
	replace_admissionregistration_v1_mutating_webhook_configuration (name: STRING_32; body: IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION
			-- 
	...
	replace_admissionregistration_v1_validating_webhook_configuration (name: STRING_32; body: IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK_CONFIGURATION
			-- 
	...
	watch_admissionregistration_v1_mutating_webhook_configuration (name: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
		...
		do
			...
			l_path := "/apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
	...
	watch_admissionregistration_v1_mutating_webhook_configuration_list (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/admissionregistration.k8s.io/v1/watch/mutatingwebhookconfigurations"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "labelSelector", label_selector));
	...
	watch_admissionregistration_v1_validating_webhook_configuration (name: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
		...
		do
			...
			l_path := "/apis/admissionregistration.k8s.io/v1/watch/validatingwebhookconfigurations/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
	...
	watch_admissionregistration_v1_validating_webhook_configuration_list (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
			-- 
		...
		do
			...
			l_path := "/apis/admissionregistration.k8s.io/v1/watch/validatingwebhookconfigurations"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "labelSelector", label_selector));
