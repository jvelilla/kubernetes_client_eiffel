...
feature -- API Access
	...
	core_ap_iversions : detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_VERSIONS
			...
			-- 
			-- 
			-- Result IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_VERSIONS
		require
		local
  			l_path: STRING
		...
		do
			...
			elseif attached { IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_VERSIONS } l_response.data ({ IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_VERSIONS }) as l_data then
				Result := l_data
			else
