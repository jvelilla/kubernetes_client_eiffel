...
feature -- API Access
	...
	create_node_v1beta1_runtime_class (body: IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS
		require
		local
  			l_path: STRING
		...
		do
			...
			l_path := "/apis/node.k8s.io/v1beta1/runtimeclasses"
			...
			elseif attached { IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS } l_response.data ({ IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS }) as l_data then
				Result := l_data
			else
	...
	delete_node_v1beta1_runtime_class (name: STRING_32; pretty: STRING_32; dry_run: STRING_32; grace_period_seconds: INTEGER_32; orphan_dependents: BOOLEAN; propagation_policy: STRING_32; body: detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_DELETE_OPTIONS): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_STATUS
			-- 
		...
		do
			...
			create l_request
			l_request.set_body(body)
			l_path := "/apis/node.k8s.io/v1beta1/runtimeclasses/{name}"
	...
	list_node_v1beta1_runtime_class (pretty: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS_LIST
			-- 
			...
			-- 
			-- 
			-- Result IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS_LIST
		require
		local
  			l_path: STRING
  			l_request: API_CLIENT_REQUEST
		...
		do
			...
			if l_response.has_error then
				last_error := l_response.error
			elseif attached { IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS_LIST } l_response.data ({ IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS_LIST }) as l_data then
				Result := l_data
			else
				create last_error.make ("Unknown error: Status response [ " + l_response.status.out + "]")
			end
	...
	node_v1beta1_ap_iresources : detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_RESOURCE_LIST
		...
		do
			...
			l_path := "/apis/node.k8s.io/v1beta1/"
	...
	patch_node_v1beta1_runtime_class (name: STRING_32; body: ANY; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32; force: BOOLEAN): detachable IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS
			-- 
	...
	read_node_v1beta1_runtime_class (name: STRING_32; pretty: STRING_32): detachable IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS
			-- 
	...
	replace_node_v1beta1_runtime_class (name: STRING_32; body: IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS; pretty: STRING_32; dry_run: STRING_32; field_manager: STRING_32; field_validation: STRING_32): detachable IO_K8S_API_NODE_V1BETA1_RUNTIME_CLASS
			-- 
	...
	watch_node_v1beta1_runtime_class (name: STRING_32; allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/node.k8s.io/v1beta1/watch/runtimeclasses/{name}"
			l_path.replace_substring_all ("{"+"name"+"}", api_client.url_encode (name.out))
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
	...
	watch_node_v1beta1_runtime_class_list (allow_watch_bookmarks: BOOLEAN; continue: STRING_32; field_selector: STRING_32; label_selector: STRING_32; limit: INTEGER_32; pretty: STRING_32; resource_version: STRING_32; resource_version_match: STRING_32; timeout_seconds: INTEGER_32; watch: BOOLEAN): detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_WATCH_EVENT
		...
		do
			...
			l_path := "/apis/node.k8s.io/v1beta1/watch/runtimeclasses"
			l_request.fill_query_params(api_client.parameter_to_tuple("", "allowWatchBookmarks", allow_watch_bookmarks));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "continue", continue));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "fieldSelector", field_selector));
			l_request.fill_query_params(api_client.parameter_to_tuple("", "labelSelector", label_selector));
