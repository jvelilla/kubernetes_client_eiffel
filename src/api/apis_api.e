...
feature -- API Access
	...
	ap_iversions : detachable IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_GROUP_LIST
			...
			-- 
			-- 
			-- Result IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_GROUP_LIST
		require
		local
  			l_path: STRING
		...
		do
			...
			elseif attached { IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_GROUP_LIST } l_response.data ({ IO_K8S_APIMACHINERY_PKG_APIS_META_V1_API_GROUP_LIST }) as l_data then
				Result := l_data
			else
