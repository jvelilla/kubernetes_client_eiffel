...
**spec** | [**IO_K8S_API_CORE_V1_REPLICATION_CONTROLLER_SPEC**](io.k8s.api.core.v1.ReplicationControllerSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_CORE_V1_REPLICATION_CONTROLLER_STATUS**](io.k8s.api.core.v1.ReplicationControllerStatus.md) |  | [optional] [default to null]
