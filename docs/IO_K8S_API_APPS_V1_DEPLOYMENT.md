...
**spec** | [**IO_K8S_API_APPS_V1_DEPLOYMENT_SPEC**](io.k8s.api.apps.v1.DeploymentSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_APPS_V1_DEPLOYMENT_STATUS**](io.k8s.api.apps.v1.DeploymentStatus.md) |  | [optional] [default to null]
