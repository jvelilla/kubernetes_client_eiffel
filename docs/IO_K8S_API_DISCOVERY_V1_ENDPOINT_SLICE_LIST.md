# IO_K8S_API_DISCOVERY_V1_ENDPOINT_SLICE_LIST
...
**items** | [**LIST [IO_K8S_API_DISCOVERY_V1_ENDPOINT_SLICE]**](io.k8s.api.discovery.v1.EndpointSlice.md) | List of endpoint slices | [default to null]
