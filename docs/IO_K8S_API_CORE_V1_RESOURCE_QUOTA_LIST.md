...
**items** | [**LIST [IO_K8S_API_CORE_V1_RESOURCE_QUOTA]**](io.k8s.api.core.v1.ResourceQuota.md) | Items is a list of ResourceQuota objects. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/ | [default to null]
