...
**webhooks** | [**LIST [IO_K8S_API_ADMISSIONREGISTRATION_V1_VALIDATING_WEBHOOK]**](io.k8s.api.admissionregistration.v1.ValidatingWebhook.md) | Webhooks is a list of webhooks and the affected resources and operations. | [optional] [default to null]
