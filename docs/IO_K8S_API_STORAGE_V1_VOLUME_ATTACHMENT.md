...
**spec** | [**IO_K8S_API_STORAGE_V1_VOLUME_ATTACHMENT_SPEC**](io.k8s.api.storage.v1.VolumeAttachmentSpec.md) |  | [default to null]
**status** | [**IO_K8S_API_STORAGE_V1_VOLUME_ATTACHMENT_STATUS**](io.k8s.api.storage.v1.VolumeAttachmentStatus.md) |  | [optional] [default to null]
