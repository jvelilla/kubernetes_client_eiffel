...
**items** | [**LIST [IO_K8S_API_STORAGE_V1ALPHA1_CSI_STORAGE_CAPACITY]**](io.k8s.api.storage.v1alpha1.CSIStorageCapacity.md) | Items is the list of CSIStorageCapacity objects. | [default to null]
