...
**items** | [**LIST [IO_K8S_API_POLICY_V1BETA1_POD_DISRUPTION_BUDGET]**](io.k8s.api.policy.v1beta1.PodDisruptionBudget.md) | items list individual PodDisruptionBudget objects | [default to null]
