...
**items** | [**LIST [IO_K8S_API_AUTOSCALING_V2_HORIZONTAL_POD_AUTOSCALER]**](io.k8s.api.autoscaling.v2.HorizontalPodAutoscaler.md) | items is the list of horizontal pod autoscaler objects. | [default to null]
