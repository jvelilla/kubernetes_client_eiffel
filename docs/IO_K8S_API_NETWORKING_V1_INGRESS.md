...
**spec** | [**IO_K8S_API_NETWORKING_V1_INGRESS_SPEC**](io.k8s.api.networking.v1.IngressSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_NETWORKING_V1_INGRESS_STATUS**](io.k8s.api.networking.v1.IngressStatus.md) |  | [optional] [default to null]
