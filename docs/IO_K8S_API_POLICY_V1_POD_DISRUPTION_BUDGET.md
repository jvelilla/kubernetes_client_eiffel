...
**spec** | [**IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET_SPEC**](io.k8s.api.policy.v1.PodDisruptionBudgetSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_POLICY_V1_POD_DISRUPTION_BUDGET_STATUS**](io.k8s.api.policy.v1.PodDisruptionBudgetStatus.md) |  | [optional] [default to null]
