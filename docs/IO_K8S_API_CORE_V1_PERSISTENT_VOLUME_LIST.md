...
**items** | [**LIST [IO_K8S_API_CORE_V1_PERSISTENT_VOLUME]**](io.k8s.api.core.v1.PersistentVolume.md) | List of persistent volumes. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes | [default to null]
