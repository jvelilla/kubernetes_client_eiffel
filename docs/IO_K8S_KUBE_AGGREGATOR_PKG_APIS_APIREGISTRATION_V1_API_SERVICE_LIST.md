...
**items** | [**LIST [IO_K8S_KUBE_AGGREGATOR_PKG_APIS_APIREGISTRATION_V1_API_SERVICE]**](io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService.md) | Items is the list of APIService | [default to null]
