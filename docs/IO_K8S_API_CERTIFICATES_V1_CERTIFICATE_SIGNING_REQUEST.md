...
**spec** | [**IO_K8S_API_CERTIFICATES_V1_CERTIFICATE_SIGNING_REQUEST_SPEC**](io.k8s.api.certificates.v1.CertificateSigningRequestSpec.md) |  | [default to null]
**status** | [**IO_K8S_API_CERTIFICATES_V1_CERTIFICATE_SIGNING_REQUEST_STATUS**](io.k8s.api.certificates.v1.CertificateSigningRequestStatus.md) |  | [optional] [default to null]
