...
**spec** | [**IO_K8S_API_CORE_V1_PERSISTENT_VOLUME_SPEC**](io.k8s.api.core.v1.PersistentVolumeSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_CORE_V1_PERSISTENT_VOLUME_STATUS**](io.k8s.api.core.v1.PersistentVolumeStatus.md) |  | [optional] [default to null]
