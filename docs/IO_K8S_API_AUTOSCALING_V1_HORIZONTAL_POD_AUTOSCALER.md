...
**spec** | [**IO_K8S_API_AUTOSCALING_V1_HORIZONTAL_POD_AUTOSCALER_SPEC**](io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_AUTOSCALING_V1_HORIZONTAL_POD_AUTOSCALER_STATUS**](io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerStatus.md) |  | [optional] [default to null]
