...
**spec** | [**IO_K8S_API_FLOWCONTROL_V1BETA2_PRIORITY_LEVEL_CONFIGURATION_SPEC**](io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfigurationSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_FLOWCONTROL_V1BETA2_PRIORITY_LEVEL_CONFIGURATION_STATUS**](io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfigurationStatus.md) |  | [optional] [default to null]
