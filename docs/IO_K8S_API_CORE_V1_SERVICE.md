...
**spec** | [**IO_K8S_API_CORE_V1_SERVICE_SPEC**](io.k8s.api.core.v1.ServiceSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_CORE_V1_SERVICE_STATUS**](io.k8s.api.core.v1.ServiceStatus.md) |  | [optional] [default to null]
