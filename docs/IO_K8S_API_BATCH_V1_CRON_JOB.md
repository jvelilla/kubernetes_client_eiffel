...
**spec** | [**IO_K8S_API_BATCH_V1_CRON_JOB_SPEC**](io.k8s.api.batch.v1.CronJobSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_BATCH_V1_CRON_JOB_STATUS**](io.k8s.api.batch.v1.CronJobStatus.md) |  | [optional] [default to null]
