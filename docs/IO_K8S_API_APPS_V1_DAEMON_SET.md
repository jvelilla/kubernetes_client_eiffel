...
**spec** | [**IO_K8S_API_APPS_V1_DAEMON_SET_SPEC**](io.k8s.api.apps.v1.DaemonSetSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_APPS_V1_DAEMON_SET_STATUS**](io.k8s.api.apps.v1.DaemonSetStatus.md) |  | [optional] [default to null]
