...
**items** | [**LIST [IO_K8S_API_CORE_V1_PERSISTENT_VOLUME_CLAIM]**](io.k8s.api.core.v1.PersistentVolumeClaim.md) | A list of persistent volume claims. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims | [default to null]
