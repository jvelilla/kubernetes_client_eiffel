...
**items** | [**LIST [IO_K8S_API_ADMISSIONREGISTRATION_V1_MUTATING_WEBHOOK_CONFIGURATION]**](io.k8s.api.admissionregistration.v1.MutatingWebhookConfiguration.md) | List of MutatingWebhookConfiguration. | [default to null]
