...
**items** | [**LIST [IO_K8S_API_POLICY_V1BETA1_POD_SECURITY_POLICY]**](io.k8s.api.policy.v1beta1.PodSecurityPolicy.md) | items is a list of schema objects. | [default to null]
