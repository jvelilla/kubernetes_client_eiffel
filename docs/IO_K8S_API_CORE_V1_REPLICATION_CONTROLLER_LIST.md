...
**items** | [**LIST [IO_K8S_API_CORE_V1_REPLICATION_CONTROLLER]**](io.k8s.api.core.v1.ReplicationController.md) | List of replication controllers. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller | [default to null]
