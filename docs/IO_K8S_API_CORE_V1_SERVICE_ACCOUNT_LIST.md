...
**items** | [**LIST [IO_K8S_API_CORE_V1_SERVICE_ACCOUNT]**](io.k8s.api.core.v1.ServiceAccount.md) | List of ServiceAccounts. More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/ | [default to null]
