...
**spec** | [**IO_K8S_API_APPS_V1_REPLICA_SET_SPEC**](io.k8s.api.apps.v1.ReplicaSetSpec.md) |  | [optional] [default to null]
**status** | [**IO_K8S_API_APPS_V1_REPLICA_SET_STATUS**](io.k8s.api.apps.v1.ReplicaSetStatus.md) |  | [optional] [default to null]
